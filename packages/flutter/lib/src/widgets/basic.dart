...
class Opacity extends SingleChildRenderObjectWidget {
  ...
  const Opacity({
    ...
    Widget child
  }) : assert(opacity != null && opacity >= 0.0 && opacity <= 1.0), super(key: key, child: child);
...
class ShaderMask extends SingleChildRenderObjectWidget {
  ...
  const ShaderMask({
    ...
    Widget child
  }) : assert(shaderCallback != null), assert(transferMode != null), super(key: key, child: child);
...
class BackdropFilter extends SingleChildRenderObjectWidget {
  ...
  const BackdropFilter({
    ...
    Widget child
  }) : assert(filter != null), super(key: key, child: child);
...
class Transform extends SingleChildRenderObjectWidget {
  ...
  const Transform({
    ...
    Widget child
  }) : assert(transform != null), super(key: key, child: child);
...
class FractionalTranslation extends SingleChildRenderObjectWidget {
  ...
  const FractionalTranslation({
    ...
    this.transformHitTests: true,
    Widget child
  }) : assert(translation != null), super(key: key, child: child);
...
class RotatedBox extends SingleChildRenderObjectWidget {
  ...
  const RotatedBox({
    ...
    Widget child
  }) : assert(quarterTurns != null), super(key: key, child: child);
...
class Padding extends SingleChildRenderObjectWidget {
  ...
  const Padding({
    ...
    Widget child
  }) : assert(padding != null), super(key: key, child: child);
...
class CustomSingleChildLayout extends SingleChildRenderObjectWidget {
  ...
  const CustomSingleChildLayout({
    ...
    Widget child
  }) : assert(delegate != null), super(key: key, child: child);
